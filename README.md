...
- `secret_type` (string, required) — One of: aws_access_key, aws_secret_key, github_token,
  stripe_key, gcp_key, azure_key
...
15 patterns across 6 categories: AWS keys (AKIA/ASIA), GitHub tokens (ghp_/gho_/github_pat_), Stripe
(sk_live_/rk_live_), GCP service accounts, Azure connections, generic API keys, private key blocks,
JWT tokens, connection strings, basic auth headers.
